#########################################################################################################################################################################
#                                                                                                                                                                       #
#                                                       Earthquake Potential Prediction Training Program Ver 2.0                                                       #
#                                                                                                                                                                       #
#########################################################################################################################################################################
#                                                                                                                                                                       #  
#                                                                   Created by                                                                                          #
...
# The applications uses the data to create a training and test set to learn how to predict potential locations.                                                         #
# Potential locations are visualised using a heat map.                                                                                                                  #
#                                                                                                                                                                       #
#########################################################################################################################################################################
